...
$$
BEGIN
    -- Use fully-qualified name because background worker may have different search_path
    perform add_job('test_proc_with_check', schedule_interval => '10 secs', config => '{}', check_config => 'public.renamed_func');
END
$$;
