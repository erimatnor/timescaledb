 ...
 * SQL functions
 */
PG_FUNCTION_INFO_V1(timescaledb_fdw_handler);
...
static FdwRoutine routine = {
	...
	.IsForeignRelUpdatable = postgresIsForeignRelUpdatable,
	.PlanDirectModify = postgresPlanDirectModify,
	.BeginDirectModify = postgresBeginDirectModify,
	.IterateDirectModify = postgresIterateDirectModify,
	.EndDirectModify = postgresEndDirectModify,

	/* Function for EvalPlanQual rechecks */
	.RecheckForeignScan = postgresRecheckForeignScan,
	/* Support functions for EXPLAIN */
	.ExplainForeignScan = postgresExplainForeignScan,
	.ExplainForeignModify = postgresExplainForeignModify,
	.ExplainDirectModify = postgresExplainDirectModify,

	/* Support functions for ANALYZE */
	.AnalyzeForeignTable = postgresAnalyzeForeignTable,

	/* Support functions for IMPORT FOREIGN SCHEMA */
	.ImportForeignSchema = postgresImportForeignSchema,

	/* Support functions for join push-down */
	.GetForeignJoinPaths = postgresGetForeignJoinPaths,

	/* Support functions for upper relation push-down */
	.GetForeignUpperPaths = postgresGetForeignUpperPaths,

};

FdwRoutine *
fdw_get_routine(void)
{
	return &routine;
}
...
{
	PG_RETURN_POINTER(fdw_get_routine());
}
