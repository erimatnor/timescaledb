...
ScanIterator
ts_chunk_data_node_iterator_by_chunk_id(LOCKMODE lockmode, MemoryContext result_mcxt)
{
	ScanIterator it = ts_scan_iterator_create(CHUNK_DATA_NODE, lockmode, result_mcxt);
